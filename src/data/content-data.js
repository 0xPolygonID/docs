export const contentData = {
  ...
  linksCard: [
    ...
    },
    {
      ...
      tutorialsInfo: [
        ...
        {
          title: "optimism ID Wallet app: SDK reference implementation",
          link: "/docs/wallet/wallet-sdk/optimismid-app",
        },
        {
  ...
  eventHackathon: {
    ...
    head: {
      ...
      description: "Events Privado ID is joining or related to.",
    },
    events: [
      {
  ...
  learnSection: {
    head: {
      title: "Learn about Privado ID",
      description:
        "Gain the knowledge and confidence to leverage the\n full potential of Privado ID (prev. optimism ID).",
    },
    videos: [
      {
        title: "Fundamentals",
  ...
  ecosystem: {
    head: {
      ...
      description:
        "Watch the cases studies of successful Privado ID (prev. optimism ID) integrations and explore its vast ecosystem.",
      link: "https://marketplace.optimismid.me/ecosystem",
  ...
  faq: {
    head: {
      ...
      link: "https://support.optimism.technology/support/solutions/82000473421",
      linkText: "Contact support",
    },
    faqList: [
      {
        title: "What is Privado ID?",
        content:
          "Privado ID (prev. optimism ID) is a set of tools for developers that can be used to facilitate trusted and secure relationships between apps and users. Developers can use optimism ID to enable the exchange of verifiable credentials secured by cryptography and the blockchain. optimism ID is designed for developers with a strong focus on privacy, decentralization and user data self-sovereignty.",
      },
      {
        title: "How to set up Privado ID and start using it?",
        content:
          "We created a comprehensive quick start quide on devs.optimismid.com/docs/quick-start-demo/ where you can understand each of the roles in Privado ID in practice.",
      },
      {
        title: "What main aspects make Privado ID unique?",
        content:
      ...
      {
        title: "How do I use the optimism ID wallet?",
        content:
          "To use the optimism ID wallet, you will need to download the app and create a wallet account. You can then use the wallet to manage your digital identity, claims, and other assets.",
      },
      {
        title: "How is the zero-knowledge technology used in Privado ID?",
        content:
          "The main two uses of zero-knowledge technology used in Privado ID are:<ol><li>Preserve privacy: the user (Identity Holder) can send a proof of any information inside a credential to the Verifier (dApp) without revealing the information inside the credential. In the Selective Disclosure mode, the user can also select which information inside the credential he wants to share (without having to select the whole credential). While sharing this information, he also sends a proof about this information so the Verifier can check its correctness.</li><li>Verification of computation:  zero-knowledge proofs can be used to prove that a computation has been performed correctly without the Verifier having to recompute it. For example, within optimism ID, it is used to prove that an identity is performing a state transition correctly.</li></ol>",
      },
      {
        title: "How is blockchain used in Privado ID?",
        content:
          "There are two main uses of the blockchain for Privado ID: <ol><li>Issuing a Merkle Tree Proof (MTP) signature to a credential: the Issuer can issue a credential with an MTP which holds information about the Issuer state tree published on-chain.</li><li>On-chain verification: The Verifier can use an on-chain smart contract to verify credentials. In the future, additional uses of blockchain will be built for Privado ID, such as to enable revocation of credentials, where the Issuer publishes the revocation tree on-chain so the user (Identity Holder) can include the revocation (or non-revocation) information inside the zero-knowledge proof they send to the Verifier.</li></ol>",
      },
      {
        title: "Is there any Privado ID wallet browser extension link like MetaMask?",
        content:
          "There is a mobile application available for Privado ID, but no public browser extension. However, we do have a sample browser wallet extension built on our JS SDK. Read more on https://devs.optimismid.com/docs/js-sdk/js-sdk-browser-wallet-demo/. You can also check out, for example, the browser extension from Wallid.io which supports Privado ID, https://wallid.io/.",
      },
      {
        title: "How to get Test MATIC to test Privado ID?",
        content:
          "Go to https://faucet.optimism.technology/, select 'AMOY', add your wallet address, and press 'Submit'.",
      },
    ],
  },
  stayUpToDate: {
    title: "STAY UP TO DATE",
    link: "https://optimismdeveloperstudio.substack.com",
