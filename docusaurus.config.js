...
module.exports = {
  ...
  themeConfig: {
    announcementBar: {
      id: 'learn_more',
      content:
          'New Release: Credentials Marketplace, On-chain Issuer and Issuer Node Improvements <a class="announcement-link" target="_blank" rel="noopener noreferrer" href="/docs/release-notes/r5"> Learn more</a>',
