...
- Privacy by design and Self-sovereignty: The user is in full control of their identity data and exchanges credentials with other identities without the need for an intermediary or centralized authority.
