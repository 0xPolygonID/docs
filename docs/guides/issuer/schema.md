...
The executable code and further schemas examples for this section can be found [<ins>here</ins>](https://github.com/0xPolygonID/tutorial-examples/tree/main/credential-schema).
...
### Define field to include in Schema
...
### Create Vocabulary of Schema Type
...
The lines which are underlined are the only ones that need to be modified in order to create a new Schema Type.
