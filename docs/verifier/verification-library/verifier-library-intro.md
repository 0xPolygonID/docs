...
- The user generates a ZK proof on mobile according to the request of the website starting from the credentials held in their wallet. This also contains the ZK proof that the credential is not revoked.
