...
The Credentials main page shows information about all the credentials that have been granted. Each one of those credentials can be revoked by clicking on the 3 dots at the end of the row.
