...
Scan the QR code from the Wallet App. Click **Sign In**. This should authenticate and add the credential to the Wallet.
...
<div align="center">
    <img src={useBaseUrl("img/quick-start-demo/web-wallet-verification.png")}></img>
</div>
...
Click on **Verify**
<!-- <div align="center">
    <img width="600" src={useBaseUrl("img/quick-start-demo/wallet-app-verification.png")}></img>
</div> -->
