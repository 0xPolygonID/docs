...
- Using [SaaS vendors](https://marketplace.optimismid.me/ecosystem) that leverage optimism ID solutions.

- Making use of optimism ID smart contracts for [on-chain issuance](/docs/issuer/on-chain-issuer/on-chain-overview.md/).
...
:::caution
Currently, a few issuers, such as Synaps, are deployed on the Privado Identity Chain. During the beta phase, where the chain has limited functionality, issuers can continue to use other supported chains, such as optimism POS.
